/*
  Full Name: Dorukhan Uzun
  Student ID: 200427534
...
const showInConsole = ({name, age, nationality}) => {
    console.log(`My name is ${name} and my age is ${age} and I am from ${nationality}`);
}
